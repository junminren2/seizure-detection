...
def main():
    time_start = time.time()
    dir = './026/2020-07-15/move'  # all files in this directionary
    newdir = dir  # all files are moved in this directionary
    excel_path = 'cut.xlsx'  # excel_path
    goal_path1 = './026/2020-07-15/move_1'  # case files are moved in this direcitionary
    if not os.path.exists(goal_path1):
        os.makedirs(goal_path1)
    goal_path2 = './026/2020-07-15/s-moving'  # control files are moved in this direcitionary
    if not os.path.exists(goal_path2):
        os.makedirs(goal_path2)
    goal_path3 = './026/2020-07-15/standing_eating'  # preprocessed case files are moved in this direcitionary
    if not os.path.exists(goal_path3):
        os.makedirs(goal_path3)
    goal_path4 = './026/2020-07-15/walking'  # preprocessed control files are moved in this direcitionary
    if not os.path.exists(goal_path4):
        os.makedirs(goal_path4)
    goal_path5 = './026/2020-07-15/digging'  # preprocessed control files are moved in this direcitionary
    if not os.path.exists(goal_path5):
        os.makedirs(goal_path5)
    goal_path6 = './026/2020-07-15/misc_movement'  # preprocessed control files are moved in this direcitionary
